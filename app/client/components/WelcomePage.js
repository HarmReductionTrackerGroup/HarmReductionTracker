    ...
    return (
      <React.Fragment>
        <div className='container-content'>
          ...
          <p className='center-justify'>Thank for supporting our community! Please select an option below to scan a QR code or input a serial number and complete the corresonding form to the best of your knowledge before distributing a Naloxone kit.</p>
